package com.fortunate.globochats
...
//        preferenceManager.preferenceDataStore = dataStore
        ...
        val fontSize = findPreference<SeekBarPreference>(getString(R.string.key_font_size))
        fontSize?.summary = getString(R.string.summary_font_size)
